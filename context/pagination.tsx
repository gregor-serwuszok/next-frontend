...
type PaginationContextState = {
  ...
  setPagination: (entity: Entity, page: number, limit: number) => void
  updateItemQty: (entity: Entity, itemQty: number) => void
}
...
export const PaginationContextProvider: FC = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (configLoaded) {
      ...
      const paginationEntities: Entity[] = ["product", "attribute", "attributeSet"]
  ...
  const updateItemQty = (entity: Entity, itemQty: number) => {
    setState({
      ...state,
      [entity]: {
        ...state[entity],
  ...
  const setPagination = (entity: Entity, page: number, limit: number) => {
    setState({
      ...state,
      [entity]: {
        ...state[entity],
